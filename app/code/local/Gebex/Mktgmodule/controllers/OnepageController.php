...
class Gebex_Mktgmodule_OnepageController extends  Mage_Checkout_OnepageController{
	public function saveMarketingAction(){
		if ($this->_expireAjax()) {
			return;
		}
		if ($this->getRequest()->isPost()) {
			$data = $this->getRequest()->getPost('marketing', array());

			$result = $this->getOnepage()->saveMarketing($data);
	...
	*/
	public function saveMarketing3Action(){
		if ($this->_expireAjax()) {
			return;
		}
	...
	protected function _getMarketing3Html()
	{
